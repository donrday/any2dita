...
<xsl:stylesheet
	...
	<div class="sitemap" style="border:thin black solid; padding:1em; background-color:#FFFFFF; width:97%;">
			<p>A CSS-rendered tree from a ditamap document: <i>(concept demo)</i></p>
			<h1>
		 		<xsl:if test="@id">
		...
		<ul id="utilityNav">
			<li><a href="/tool1">Interaction 1</a></li>
			<li><a href="/tool2">Interaction 2</a></li>
			<li><a href="/too3">Interaction 3</a></li>
		</ul>
	...
	<xsl:template match='*[contains(@class," mapgroup-d/topichead ")]'>
		<li>
			<a href="TitledNode"><xsl:value-of select="@navtitle"/></a>
			<xsl:if test='*[contains(@class," map/topicref ")]'>
				<ul>
					<xsl:apply-templates select='*[contains(@class," map/topicref ")]'/>
					<br clear="both" />
	...
	<xsl:template match='*[contains(@class," map/topicmeta ")]'>
		<li>
			<a href="/toolz"><xsl:value-of select="@navtitle"/></a>
			<xsl:if test='*[contains(@class," map/topicref ")]'>
				<ul>
					<xsl:apply-templates select='*[contains(@class," map/topicref ")]'/>
					<br clear="both" />
