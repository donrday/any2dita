...
<!-- markup conversion: map elements -->
	...
	<xsl:template name='map' match='*[contains(@class," map/map ")]' mode="process">
		<div id="impress">
		    <!-- Title slide -->
		    <div id="title" class="step slide" data-x="0" data-y="0"  style="font-size:120%;">
				<p><a href="{$serviceType}/map/{$resourceName}?themeName={$tempTheme}"><img src="{$contentDir}/{$groupName}/{$siteLogo}"/></a></p>
			    <div style="padding:3em;">
					<h1 class="topictitle1" style="font-size:200%;font-weight:bold;line-height:120%;"><?php echo $postTitleTxt; ?></h1>
					<div class="body" style="font-size:120%;">
					<p><?php echo $postNavtitle; ?></p>
					<p><?php echo $postAuthor; ?>, <?php echo $postSource; ?></p>
					<!--
					<ul>
					<li>< ?php echo $postDescription; ?></li>
					<li><xsl:apply-templates select='*[contains(@class," map/topicmeta ")]/*[contains(@class," map/author ")]'/></li>
					<li><xsl:apply-templates select='*[contains(@class," map/topicmeta ")]/*[contains(@class," map/source ")]'/></li>
					<li><xsl:apply-templates select='*[contains(@class," map/topicmeta ")]/*[contains(@class," topic/othermeta ")]'/></li>
			        <li><i>(< ?php //echo "FILE: $groupName/$file"; ?>)</i></li>
					</ul>
					-->
					</div>
				</div>
