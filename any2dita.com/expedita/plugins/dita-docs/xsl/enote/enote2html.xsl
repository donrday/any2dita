...
<xsl:template match="*[contains(@class,' enote/noteheader ')]">
	...
	<div space-before="12pt" style="border:thin black solid; background:silver;">
...
<xsl:template match="*[contains(@class,' enote/notebody ')]">
	<div space-before="12pt" style="border:thin black solid; background:white;">
		<xsl:apply-templates/>
	</div>
</xsl:template>
